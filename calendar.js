...
const SOLAR_EVENTS = {
  ...
  '3-3':  { t: 'ទិវាវប្បធម៌ជាតិ', k: 'holiday' },
  ...
  '5-20': { t: 'ទិវារំលឹកវិញ្ញាណក្ខន្ធ (២០ ឧសភា)', k: 'holiday' },
  '6-1':  { t: 'ទិវាកុមារអន្តរជាតិ', k: 'holiday' },
  ...
  '12-10': { t: 'ទិវាសិទ្ធិមនុស្សអន្តរជាតិ', k: 'holiday' },
...
function lunarEventsFor(ceYear) {
  ...
  add(fullMoonOf(ceYear, 11), 'ពិធីទាញព្រ័ត្រ', 'festival');            // full moon ខែអស្សុជ
